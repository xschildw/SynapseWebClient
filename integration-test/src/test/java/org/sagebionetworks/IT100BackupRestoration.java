...
public class IT100BackupRestoration {
	 ...
	 */
	public BackupRestoreStatus waitForDaemon(String daemonId) throws ClientProtocolException, IOException, JSONException, SynapseUserException, SynapseServiceException, JSONObjectAdapterException, InterruptedException{
